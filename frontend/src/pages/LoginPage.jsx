        ...
        <div className="flex justify-center items-center min-h-screen px-4 pt-24 pb-12 relative z-10">
            ...
            <form onSubmit={submitHandler} className="w-full max-w-md bg-white dark:bg-[#1E1E1E]/80 backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-2xl p-8 shadow-xl dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] relative">
                ...
                <div className="text-center mb-8">
                    <h1 className="font-extrabold text-3xl mb-2 text-gray-900 dark:text-white tracking-tight">Welcome Back</h1>
                    <p className="text-gray-500 dark:text-slate-400 font-medium text-sm">Sign in to your HireMe account.</p>
                </div>
                ...
                >
                    {loading ? "Verifying..." : "Sign In to HireMe"}
                </button>
                
                <p className="mt-8 text-center text-sm text-gray-500 dark:text-slate-400 font-medium">
                    Don't have an account? <Link to="/register" className="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 transition-colors underline-offset-4 hover:underline font-semibold">Sign up for free</Link>
                </p>
            </form>
        </div>
    );
